...
<head runat="server">
    ...
    <title>Aufgabe "<%=Model.Aufgabe.Titel%>" bearbeiten</title>
</head>
<body>
    <div>
        <h1>Aufgabe "<%=Model.Aufgabe.Titel%>" bearbeiten</h1>
        <p>Die folgende Aufgabe können Sie bearbeiten.</p>
        ...
        <%Using Html.BeginForm()%>
            ...
            <p>
                ...
                <%=Html.DropDownListFor(Function(m) Model.Aufgabe.Kategorie.Id, 
                           New SelectList(Model.KategorienAlle, "ID", "Bezeichnung"))%>
